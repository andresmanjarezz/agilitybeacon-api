...
def get_applicationurl(db: Session, applicationurl_id: int):
    applicationurl = (
        ...
        .filter(models.ApplicationUrl.id == applicationurl_id)
        .first()
    )
...
def create_applicationurl(
    db: Session, applicationurl: schemas.ApplicationUrlCreate
):
...
def edit_applicationurl(
    ...
    applicationurl: schemas.ApplicationUrlEdit,
